...
//     allMatches.add(matchRoommates1(roommates["IFMR"]![key2]!));
//     // assignedRooms
//     //     .add(assignRooms(rooms, matchRoommates1(roommates[key1]![key2]!)));
//   }
//   // }
//   // print(jsonEncode(allMatches));
...
//       if (pair[1] != null) {
//         print("For school: ${pair[0]!.school}");
//         print(
//             "${pair[0]!.name} is paired with ${pair[1]!.name} with a score of ${customScore(pair[0]!, pair[1]!)}");
//       } else {
//         print("For school: ${pair[0]!.school}");
//         print("${pair[0]!.name} is unmatched");
//       }
//     }
//   }
//   return allMatches;
